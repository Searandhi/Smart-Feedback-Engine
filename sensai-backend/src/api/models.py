...
class CreatePracticeAssignmentRequest(BaseModel):
    course_id: int
    title: str
    description: str
    input_format: str
    ...
    input_type: str = "code"      # code | text | math


class PracticeAssignment(CreatePracticeAssignmentRequest):
    id: int
...
class SmartFeedback(BaseModel):
    ...
    pass_status: bool
    overall_summary: str
    criteria_feedback: List[CriteriaFeedback]
    socratic_nudge: str
...
class SubmissionResponse(BaseModel):
    ...
    smart_feedback: Optional[SmartFeedback] = None
...
class MentorChatRequest(BaseModel):
    assignment_id: int
    user_id: str # Changed from int to str to match learner-xxx format
    solution_code: str
    previous_feedback: Optional[SmartFeedback] = None
    user_question: str
