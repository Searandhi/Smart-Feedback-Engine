...
import { Edit, Save, Users, BookOpen, Layers, Building, ChevronDown, Trash2, ExternalLink, ClipboardList } from "lucide-react";
...
type TabType = 'courses' | 'cohorts' | 'members' | 'assignments';
        ...
        const fetchSchool = async () => {
            ...
            try {
                ...
                if (!schoolResponse.ok) {
                    setLoading(false);
                    return; // Stop execution without throwing, school remains null -> "School not found" UI
                }
                    ...
                    <main>
                        ...
                        <div className="mb-8">
                            <div className="flex border-b border-gray-200 dark:border-gray-800 overflow-x-auto">
                                <button
                                    className={`px-4 py-2 font-light cursor-pointer whitespace-nowrap ${
                                        activeTab === 'courses'
                        ...
                        <div>
                            ...
                            {activeTab === 'assignments' && (
                                <div className="py-4">
                                    <AdminAssignmentsPanel orgId={id} />
                                </div>
                            )}
                        </div>
                    </main>
